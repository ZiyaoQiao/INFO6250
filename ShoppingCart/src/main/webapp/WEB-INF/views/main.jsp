...
<html>
		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">Clothing <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">Electronics</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">Books</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">Gaming</a></li>
					<li class="list-group-item-diy"><a href="#productArea5">Personal Care</a></li>
					<li class="list-group-item-diy"><a href="#productArea6">Beauty</a></li>
					<li class="list-group-item-diy"><a href="#productArea7">Sports</a></li>
				</ul>
			</div>
			<!-- 控制内容 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					...
					<p>This is a project written by Ziyao Qiao, 001835152</p>
				</div>
  ...
  <script type="text/javascript">
      ...
      productType[1] = "Clothing";
      productType[2] = "Electronics";
      productType[3] = "Books";
      productType[4] = "Gaming";
      productType[5] = "Personal Care";
