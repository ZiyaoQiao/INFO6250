...
<html lang="zh-CN">
  <head>
    ...
    <title>Shopping Cart Search Result</title>
		...
		<div class="row margin-t">
			<div class="form-horizontal">
				...
				<div class="form-group form-group-lg col-sm-6 col-md-6">
					<input type="text" class="form-control" id="newSearchKeyWord" placeholder="keyword" />
				</div>
				<button class="btn btn-primary btn-lg col-sm-2 col-md-2 big-button" onclick="searchPre()">Search Item</button>
			</div>
		</div>
	</div>
	<div class="container">
